...
namespace Lifti.Tests
{
    public class FullTextIndexBuilderTests
    {
        ...
        public void WithCustomIndexNodeFactory_ShouldPassCustomImplementationToIndex()
        {
            ...
            var expectedRoot = new IndexNode(factory.Object, null, null, null);
            factory.Setup(f => f.CreateEmptyNode()).Returns(expectedRoot);
            ...
            factory.Verify(f => f.CreateEmptyNode(), Times.Once);
        }
        ...
        {
            var factory = new Mock<IIndexNodeFactory>();
            factory.Setup(f => f.CreateEmptyNode()).Returns(new IndexNode(factory.Object, null, null, null));
